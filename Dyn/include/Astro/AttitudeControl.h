...
//@brief: 对日姿态控制器
//@para : _Gyro:陀螺仪数据 Kp:控制器参数 _Qib:惯性系下的四元数 _SunPos:惯性系下的太阳矢量
//@return : 控制力矩

static Eigen::Vector3d ToSunControl(const GyroScope& _Gyro, double Kp, Quat _Qib, Eigen::Vector3d _SunPos);
